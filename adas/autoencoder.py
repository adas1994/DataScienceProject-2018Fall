...
#epoch_lossfile = open("epoch_loss.txt","w")
epoch_loss = []
...
np.savetxt("epoch_loss.txt",epoch_loss,delimiter='\t')
np.savetxt("encoded_rep.txt",saved_encoded_rep,delimiter='\t')
saved_encoded_rep = saved_encoded_rep.reshape(num_elements,l_dim)#int(float(len(saved_encoded_rep))/num_elements))
