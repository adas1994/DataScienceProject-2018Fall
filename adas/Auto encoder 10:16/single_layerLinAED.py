...
torch.save(model.state_dict(), './sim_autoencoderSingleLayerLin.pth')
print(type(epoch_loss))
epoch_loss = np.asarray(epoch_loss).astype(float)
np.savetxt("epoch_lossSingleLayerLin.txt",epoch_loss,delimiter='\t')
np.savetxt("encoded_repSingleLayerLin.txt",saved_encoded_rep,delimiter='\t')
